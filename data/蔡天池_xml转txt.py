...
def convert(xml_list):
    ...
    for index, line in enumerate(xml_list):
        ...
        for obj in get(root, 'object'):
            ...
            o_center_x=(xmax+xmin)/2
            o_center_y=(ymax+ymin)/2

            result.append([category_id,o_center_x,o_center_y,o_width,o_height])

        result=np.asarray(result)
        img=cv2.imread(xml_f[:-4] + ".jpg")
        h,w,_=img.shape
        result[:,1]/=w
        result[:,3]/=w
        result[:,2]/=h
        result[:,4]/=h
        np.savetxt(xml_f[:-4] + ".txt",result)
...
if __name__ == '__main__':
    ...
    # train_ratio = 0.9
    # save_json_train = r"D:\vos_coco\instances_train2014.json"
    # save_json_val = r"D:\vos_coco\instances_val2014.json"
    xml_dir = r"D:\vos_coco\tmp_xml"
    ...
    #
    # f1 = open(r"D:\vos_coco\train.txt", "w")
    ...
    #
    # f2 = open(r"D:\vos_coco\val.txt", "w")
